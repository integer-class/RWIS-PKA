        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul id="main-menu" class="metismenu animation-li-delay">
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="{{ url('rt_data_warga') }}">Data Warga</a></li>
                        <li><a href="{{ url('rt_data_keluarga') }}">Data Keluarga</a></li>
                    </ul>
                </li>
               
                <li><a href="{{url('rt_data_keuangan')}}"><i class="fa fa-money"></i> <span>Keuangan</span></a></li>
               
                <li><a href="{{url('rt_data_kegiatan')}}"><i class="fa fa-th-list"></i> <span>Kegiatan</span></a></li>
                <li><a href="{{url('rt_data_umkm')}}"><i class="fa fa-folder"></i> <span>UMKM</span></a></li>
                <li><a href="{{url('rt_data_bansos')}}"><i class="fa fa-address-book"></i> <span>Bansos</span></a></li>                    
                <li><a href="{{url('rt_templatesurat')}}"><i class="fa fa-tasks"></i> <span>Template Surat</span></a></li>
            </ul>
        </nav>     
    </div>
</div>
